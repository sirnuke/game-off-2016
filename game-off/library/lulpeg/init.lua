...
local u = require"library.lulpeg.util"
...
local API, charsets, compiler, constructors
    ...
    { "library.lulpeg.API", "library.lulpeg.charsets", "library.lulpeg.compiler", "library.lulpeg.constructors"
    , "library.lulpeg.datastructures", "library.lulpeg.evaluator", "library.lulpeg.factorizer"
    , "library.lulpeg.locale", "library.lulpeg.printers", "library.lulpeg.re" }))
